                ...
                <div class="testimonial_slider testimonial_style1 carousel_slider owl-carousel owl-theme"
                    ...
                    <div class="testimonial_box">
                        <div class="testimonial_img">
                            <img class="radius_all_5" src="{{ asset('assets/user/images/client_img1.jpg') }}" alt="client">
                        </div>
                    ...
                    <div class="testimonial_box">
                        <div class="testimonial_img">
                            <img class="radius_all_5" src="{{ asset('assets/user/images/client_img2.jpg') }}" alt="client">
                        </div>
                        <div class="testi_meta">
                            <div class="testi_user">
                                <h6>Lissa Castro</h6>
                    ...
                    <div class="testimonial_box">
                        <div class="testimonial_img">
                            <img class="radius_all_5" src="{{ asset('assets/user/images/client_img3.jpg') }}" alt="client">
                        </div>
                        <div class="testi_meta">
                            <div class="testi_user">
                                <h6>Lissa Castro</h6>
